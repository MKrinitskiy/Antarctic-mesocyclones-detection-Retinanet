...
class SAIL_val_Generator(Generator):
    def __init__(self,
        ...
        Args
            sail_annotations_file: Path to the CSV annotations file.
        ...
        super(SAIL_val_Generator, self).__init__(shuffle_groups=False, **kwargs)
